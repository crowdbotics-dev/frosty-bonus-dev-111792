"""
Django settings for frosty_bonus_dev_111792 project.
...
ROOT_URLCONF = 'frosty_bonus_dev_111792.urls'
...
WSGI_APPLICATION = 'frosty_bonus_dev_111792.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "frosty_bonus_dev_111792 API",
    "DESCRIPTION": "API documentation for frosty_bonus_dev_111792 App",
    "VERSION": "v1",
}
